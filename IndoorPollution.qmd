...
<<<<<<< HEAD
model_region_reg<- recipe(percent_IAP~region+year, data = model_data)%>%
=======
model_region_reg<-
  recipe(percent_IAP~year+region, data = model_data) %>%
>>>>>>> 295b91e34de9865891390f1909481401fab5b844
step_interact(region:year)
